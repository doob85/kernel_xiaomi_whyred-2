...
ZIP_NAME="KangarooX-MIUI-EAS-r3.4-test"
export ARCH=arm64
export CROSS_COMPILE="/home/tamas/Desktop/tc/br/bin/aarch64-buildroot-linux-gnu-"
...
then
    make defconfig O=out ARCH=arm64 kangaroox-miui-eas_defconfig
fi
...
cp $KERNELDIR/out/arch/arm64/boot/Image.*-dtb ${ANYKERNEL_DIR}/zImage-dtb
